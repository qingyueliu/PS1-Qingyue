...
The repository releases the LaTeX source, editable figure, standard-library model, notebook, saved synthetic outputs, tests, and browser game. Run \texttt{python companion/src/strategic\_reporting.py}. Submitted commit: \textbf{[ADD COMMIT]}. Student code uses the MIT License; other materials retain their terms.
