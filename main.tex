...
\newcommand{\coursemeta}{%
  ...
  \textbf{Assignment:} PS1 research proposal, v2 (September 20, 2026).\par\smallskip
}
...
Dashed arrows mark the interdisciplinary synthesis. The retained v1 design
figure supplies the baseline; v2 adds C's cooperation bonus in Sections 2--3.}
